...
struct PrivateDentalCenter: Codable, OrganizationModel, SharedCell2DataProtocol {
    ...
    var sharedCell2Image: UIImage {
        return MainHorizontalCollectionData.categoryType(.privateDentalCenters).image
    }
